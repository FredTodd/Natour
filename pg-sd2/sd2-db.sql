...
CREATE TABLE User_Info (
  ...
  Address varchar(512) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Packages (
  ...
  Destination varchar(512) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Payment (
  ...
  Amount int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Bookings (
  ...
  Price int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Reviews (
  ...
  Date Date NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE Employees (
  ...
  Email varchar(512) NOT NULL,
  P_number bigint NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO Packages (Package_ID, Name, Description, Price, Destination) VALUES
...
(783361, 4893321, 00026, '2022-07-21', 1, 1900),
(294013, 4058721, 00027, '2022-10-16', 2, 3800),
...
(19406, 'Megan', 'Travel Consultant', 'Megan@outlook.com', 07974744823),
(19228, 'Amelie', 'Customer Support', 'Amelie@gmail.com', 01582588402);
